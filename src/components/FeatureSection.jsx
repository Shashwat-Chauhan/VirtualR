        ...
        {features.map((feature, index) => {
          ...
          <div key={index} className='w-full sm:w-1/2 lg:w-1/3'>
            <div className="flex mb-8">
              <div className="flex mx-6 h-10 w-10 p-2 text-orange-700 bg-neutral-900 justify-center items-center rounded-full">
                {feature.icon}
              </div>
              <div>
                <h5 className="mb-3 text-xl">{feature.text}</h5>
